...
###
# The basic algorithm: have overstimation bias, variance and bias accumulation due to the fact that we're using a DL network to approx value and policy function
# Delay policy updates
# Smooth calculation of target and critic update
# Perform a double Q learning type modification to our learning
...
class Agent():
    def __init__(self, alpha, beta, input_dims, tau, env,
        ...
        self.target_critic_1 = CriticNetwork(alpha, input_dims, layer1_size,
                                         layer2_size, n_actions=n_actions, name='target_critic_1')
        self.target_critic_2 = CriticNetwork(alpha, input_dims, layer1_size,
    ...
    def learn(self):
        ...
        self.critic_2.optimizer.zero.grad()
